<x-master-layout>
        ...
        <div class="container-fluid">
           <div class="row  justify-content-center align-items-center d-flex text-center h-100">
             <div class="col-12 col-md-8  h-50 ">
                 ...
                 <p class="lead  text-light mb-5">Accedez aux meilleurs produits aux meilleurs prix</p>
                    <p><a href="https://blueprintsapp.launchaco.com/" class="btn bg-danger shadow-lg btn-round text-light btn-lg btn-rised">Passer votre commande ></a>
                    </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center mt-2">Nos nouveaux Produits</h1>
                <hr>
                    ...
                    <div class="card text-center mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="text-center">
                            <a class="btn btn-primary btn-sm" href="{{ route('produits.show',$produit) }}">Commander <i class="fas fa-shopping-cart"></i></a>
                        </div>
                      </div>
                    </div>
                </div>
